...
- <code><a href="./src/resources/characters.ts">CharacterGetAllCharactersResponse</a></code>
...
- <code title="get /characters">client.characters.<a href="./src/resources/characters.ts">getAllCharacters</a>({ ...params }) -> CharacterGetAllCharactersResponse</code>
...
- <code><a href="./src/resources/episodes.ts">PaginatedResponse</a></code>
...
- <code title="get /episodes">client.episodes.<a href="./src/resources/episodes.ts">list</a>({ ...params }) -> PaginatedResponse</code>
...
- <code title="get /episodes/seasons/{season_number}">client.episodes.<a href="./src/resources/episodes.ts">listBySeason</a>(seasonNumber, { ...params }) -> PaginatedResponse</code>
