...
import { BaseBelieve, ClientOptions } from './client';
 ...
 * bundle size.
 * Import the resource classes you need from `@cjavdev/believe/resources/*`.
...
): PartialBelieve<InferClientStructure<T>> {
  const client = new BaseBelieve(options);
