...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: BaseBelieve): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: BaseBelieve): Logger {
