  ...
  },
  {
    ...
    perLanguage: {
      ...
      csharp: {
        method: 'Characters.Retrieve',
        example:
          'CharacterRetrieveParams parameters = new() { CharacterID = "character_id" };\n\nvar characterz = await client.Characters.Retrieve(parameters);\n\nConsole.WriteLine(characterz);',
      },
      go: {
        method: 'client.Characters.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/cjavdev/believe-go"\n\t"github.com/cjavdev/believe-go/option"\n)\n\nfunc main() {\n\tclient := believe.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tcharacterz, err := client.Characters.Get(context.TODO(), "character_id")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", characterz.ID)\n}\n',
      },
      http: {
        example:
      ...
      java: {
        method: 'characters().retrieve',
        example:
          'package com.believe.api.example;\n\nimport com.believe.api.client.BelieveClient;\nimport com.believe.api.client.okhttp.BelieveOkHttpClient;\nimport com.believe.api.models.characters.CharacterRetrieveParams;\nimport com.believe.api.models.characters.Characterz;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        BelieveClient client = BelieveOkHttpClient.fromEnv();\n\n        Characterz characterz = client.characters().retrieve("character_id");\n    }\n}',
      },
      kotlin: {
        method: 'characters().retrieve',
        example:
          'package com.believe.api.example\n\nimport com.believe.api.client.BelieveClient\nimport com.believe.api.client.okhttp.BelieveOkHttpClient\nimport com.believe.api.models.characters.CharacterRetrieveParams\nimport com.believe.api.models.characters.Characterz\n\nfun main() {\n    val client: BelieveClient = BelieveOkHttpClient.fromEnv()\n\n    val characterz: Characterz = client.characters().retrieve("character_id")\n}',
      },
      php: {
        method: 'characters->retrieve',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$characterz = $client->characters->retrieve('character_id');\n\nvar_dump($characterz);",
      },
      python: {
        method: 'characters.retrieve',
        example:
          'import os\nfrom believe import Believe\n\nclient = Believe(\n    api_key=os.environ.get("BELIEVE_API_KEY"),  # This is the default and can be omitted\n)\ncharacterz = client.characters.retrieve(\n    "character_id",\n)\nprint(characterz.id)',
      },
      ruby: {
        method: 'characters.retrieve',
        example:
          'require "believe"\n\nbelieve = ::Believe::Client.new(api_key: "My API Key")\n\ncharacterz = believe.characters.retrieve("character_id")\n\nputs(characterz)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'characters.update',
        example:
          'require "believe"\n\nbelieve = ::Believe::Client.new(api_key: "My API Key")\n\ncharacterz = believe.characters.update("character_id")\n\nputs(characterz)',
      },
      typescript: {
        method: 'client.characters.update',
        example:
