...
const runTests = (client: PartialBelieve<{ characters: BaseCharacters }>) => {
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.characters.list({
    limit: 10,
    min_optimism: 0,
    role: 'coach',
    skip: 0,
...
describe('resource characters', () => runTests(client));
describe('resource characters (tree shakable, base)', () => runTests(partialClient));
